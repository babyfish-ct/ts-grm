...
> = { 
    [
        K in keyof TMembers as 
            TMembers[K] extends __ReferencePropContract<infer TargetModel, any, "COLUMNS", never, any, infer TargetKey>
...
export type __CriteriaReferenceKeyMember<TProp> =
    TProp extends __ReferencePropContract<infer TargetModel, infer Nullity, "COLUMNS", never, any, infer TargetKey>
        ? Nullity extends "NULLABLE"
